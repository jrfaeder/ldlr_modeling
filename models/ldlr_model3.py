...
"""
    ...
    def run(self, t_end=2, n_steps=200, out_dir='results/data'):
        """Run the simulation"""
    ...
    def get_data(self):
        ...
        print("GDAT columns:", df.columns.tolist())
        

        # detect endosome/lysosome columns
        ...
        #detect surface complex
        surface_cols = ["Surf_LA3", "Surf_LA4", "Surf_LA5", "Surf_LA7"]

        df["LDLR_surface_complex"] = df[surface_cols].sum(axis=1)
    ...
    def plot(self, save_path=None):
        ...
        axes[1,1].plot(data['time'], data['LDLR_surface_complex'], 
...
if __name__ == "__main__":
    ...
    # Plot results
    wt_model.plot(save_path='results/figures/ldlr_wt3.png')
