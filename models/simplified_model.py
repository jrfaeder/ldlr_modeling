...
begin molecule types
    LDLR(la3,loc~surface~endosome)
    LDL(ldlr,loc~extra~endo~lyso)
end molecule types

begin seed species
    LDLR(la3,loc~surface)  LDLR_init
...
begin reaction rules
    ...
    # Receptor Recycling
    LDLR(la3,loc~endosome) -> \\
        LDLR(la3,loc~surface)  k_recycle
...
"""
    ...
    def run(self, t_end=2, n_steps=2000, out_dir='results/data'):
        """Run the simulation"""
